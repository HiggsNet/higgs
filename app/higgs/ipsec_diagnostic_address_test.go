...
func TestAssignIPsecDiagnosticAddressesAllowsSameFamilyAddressOnMultipleInterfaces(t *testing.T) {
	...
	specs := []ipsec.TransportLinkSpec{
		{InterfaceName: "hgs4a", PathKey: "family:ipv4"},
		{InterfaceName: "hgs4b", PathKey: "family:ipv4"},
		{InterfaceName: "hgs6a", PathKey: "family:ipv6"},
	}
	...
	want := []string{
		"hgs4a=fd00:1234:5678:9abc::fff4/128",
		"hgs4b=fd00:1234:5678:9abc::fff4/128",
		"hgs6a=fd00:1234:5678:9abc::fff6/128",
	}
