...
func TestCloneStateFileSchemaGuard(t *testing.T) {
	...
	assertStateCloneFields(t, syncPeerState{}, "LastSyncUnix", "LastAttemptUnix", "BackoffUntilUnix", "LastRelayUnix", "LastRelayCatalogRootHex", "FailureCount", "LastError", "LastUpdateSource", "LastRelaySuppression", "LastRelaySuppressedAt", "DiscoveredAddr", "DiscoveredAtUnix", "ObservedAddr", "ObservedFirstSeenUnix", "ObservedLastSeenUnix", "ObservedLastSyncUnix", "ObservedUntilUnix", "ObservedSource", "ObservedFailureCount", "ObservedGraceAddrs", "RejectedDigests")
